...
export const getTransactionsStart = () => {
  return {
    type: actionTypes.GET_DEPOSIT_TRANSACTIONS_START
  };
};

export const getTransactionsSuccess = (transactions, next, count) => {
  return {
    type: actionTypes.GET_DEPOSIT_TRANSACTIONS_SUCCESS,
...
export const getInitialTransactionsSuccess = (transactions, next, count) => {
  return {
    type: actionTypes.GET_INITIAL_DEPOSIT_TRANSACTIONS_SUCCESS,
    transactions: transactions,
    loading: false,
    next_url: next,
    count: count
...
export const getTransactionsFail = error => {
  return {
    type: actionTypes.GET_DEPOSIT_TRANSACTIONS_FAIL,
    error: error
  };
};
...
export const getInitialTransactions = (user_id) => {
  return dispatch => {
    ...
    axios
      .post(api_url() + "/pay/depositUserTransactions",
            {user_id: user_id}
          )
      .then(res => {
