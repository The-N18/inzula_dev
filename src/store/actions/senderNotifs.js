...
export const getNotifsStart = () => {
  return {
    type: actionTypes.GET_SENDER_NOTIFS_START
  };
};

export const getNotifsSuccess = (notifs, next, count) => {
  return {
    type: actionTypes.GET_SENDER_NOTIFS_SUCCESS,
    notifs: notifs,
    loading: false,
    next_url: next,
    count: count
...
export const getInitialNotifsSuccess = (notifs, next, count) => {
  return {
    type: actionTypes.GET_INITIAL_SENDER_NOTIFS_SUCCESS,
    notifs: notifs,
    loading: false,
    next_url: next,
    count: count
...
export const getNotifsFail = error => {
  return {
    type: actionTypes.GET_SENDER_NOTIFS_FAIL,
    error: error
  };
};
...
export const getInitialNotifs = (user_id) => {
  return dispatch => {
    ...
    axios
      .get(api_url() + "/bookings/sender_notifs_list", {
