...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case actionTypes.GET_SENDER_NOTIFS_START:
      return getNotifsStart(state, action);
    case actionTypes.GET_SENDER_NOTIFS_SUCCESS:
      return getNotifsSuccess(state, action);
    case actionTypes.GET_INITIAL_SENDER_NOTIFS_SUCCESS:
      return getInitialNotifsSuccess(state, action);
    case actionTypes.GET_SENDER_NOTIFS_FAIL:
