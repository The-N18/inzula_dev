...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case actionTypes.GET_SELECTABLE_RESERVATIONS_START:
      return getReservationsStart(state, action);
    case actionTypes.GET_SELECTABLE_RESERVATIONS_SUCCESS:
      return getReservationsSuccess(state, action);
    case actionTypes.GET_INITIAL_SELECTABLE_RESERVATIONS_SUCCESS:
      return getInitialReservationsSuccess(state, action);
    case actionTypes.GET_SELECTABLE_RESERVATIONS_FAIL:
