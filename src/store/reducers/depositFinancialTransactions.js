...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case actionTypes.GET_DEPOSIT_TRANSACTIONS_START:
      return getTransactionsStart(state, action);
    case actionTypes.GET_DEPOSIT_TRANSACTIONS_SUCCESS:
      return getTransactionsSuccess(state, action);
    case actionTypes.GET_INITIAL_DEPOSIT_TRANSACTIONS_SUCCESS:
      return getInitialTransactionsSuccess(state, action);
    case actionTypes.GET_DEPOSIT_TRANSACTIONS_FAIL:
