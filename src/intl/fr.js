export const msg = {
  ...
  'how_inzula_works.earn_money': "1 - Find a shipment request and make a transport proposal",
  'how_inzula_works.earn_money': "Find a shipment request that matches your next trip. Make an offer and set your Traveler Reward - the amount your buyer will pay you for the delivery of their item.",
  'how_inzula_works.earn_money': "2- Agree on a place to meet the sender",
  'how_inzula_works.earn_money': "Once yourth proposition validated, uUse the INZULA courier to arrange a location to pick up the package. During the delivery of the package, remember: - to take a picture of yourself with the sender to certify that the package has been delivered to you - to check the identity document of the person who gives you the parcel.",
  'how_inzula_works.earn_money': "3 - Meet the recipient of the package where you are going",
  'how_inzula_works.earn_money': "Once at destination, you have 3 days from your arrival in the country to contact the recipient of the package. Arrange an appointment in a public place to deliver the package to the recipient and remember to take a photo of yourself with the latter to certify the delivery.",
  'how_inzula_works.earn_money': "4- Receive your payment",
  'how_inzula_works.earn_money': "Once the package has been delivered, validate the discount on the site. The sender then has 2 days to confirm the delivery by hand to the recipient, and you will then receive your payment.",
