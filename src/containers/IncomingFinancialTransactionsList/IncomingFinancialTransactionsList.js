...
import { getTransactions, getInitialTransactions } from "../../store/actions/incomingFinancialTransactions";
import TransactionCard from "../../containers/TransactionCard/TransactionCard";
import $ from "jquery";
import {FormattedMessage} from 'react-intl'

class IncomingFinancialTransactionsList extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
    ...
    return (
      ...
      {transactions.length === 0 ? <div><FormattedMessage
        id="incoming_user_transactions.no_transactions"
        defaultMessage="You do not have any incoming transactions yet."
      /></div> : <div
        id="scrollableDiv"
        style={{
          height: 600,
...
const mapStateToProps = state => {
  return {
    ...
    transactions: state.incomingFinancialTransactions.transactions,
    next_url: state.incomingFinancialTransactions.next_url,
    count: state.incomingFinancialTransactions.count,
  };
};
...
IncomingFinancialTransactionsList.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(IncomingFinancialTransactionsList);
