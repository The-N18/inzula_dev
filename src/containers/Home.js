                    ...
                    <div className="trend-content-main">
                      ...
                      <div className="trend-last-main">
                        <p className="mb-0 trend-para">Pour commencer, créez votre profil et renseignez le maximum d’informations sur le colis que vous souhaitez expédier.
                          Une estimation du coût du transport du colis vous sera proposée sur la plateforme.</p><br /><br /><br /><br /><br /><br />
                  ...
                  <div className="trend-item">
                    ...
                    <div className="trend-content-main">
                      ...
                      <div className="trend-last-main">
                        ...
                        </p><dd>-   à vous prendre en photo avec le transporteur</dd>
                        <dd>–   à vérifier la pièce d’identité de celui à qui vous remettez le colis</dd>
                        <dd>-   confirmer la remise du colis au voyageur à notre équipe.</dd>
                        <p /><br />
                        <div className="trend-last d-flex align-items-center justify-content-between">
                        </div>
                      </div>
                  ...
                  <div className="trend-item">
                    ...
                    <div className="trend-content-main">
                      ...
                      <div className="trend-last-main">
                        ...
                        </p><dd>- à vous prendre en photo avec l’expéditeur</dd>
                        <dd>- à vérifier la pièce d’identité de celui à qui vous récupérez  le colis</dd>
                        <dd>- confirmer le retrait du colis  à notre équipe.</dd>
                        <p /><br /><br />
                        <div className="trend-last d-flex align-items-center justify-content-between">
                        </div>
                      </div>
                  ...
                  <div className="trend-item">
                    ...
                    <div className="trend-content-main">
                      ...
                      <div className="trend-last-main">
                        ...
                        <dd>- prendre une photo de la pièce d’identité du destinataire.</dd>
                        <dd>- Récupérer le code qui vous donnera accès à votre paiement sur la plateforme</dd>
                        <p />
                        <div className="trend-last d-flex align-items-center justify-content-between">
                        </div>
                      </div>
