...
rm -rf /home/ubuntu/projects/inzula/build/ && PUBLIC_URL=https://d1g0ix8w0r103u.cloudfront.net npm run build && python3 /home/ubuntu/projects/inzula/manage.py collectstatic --noinput && ./gunicorn_start.sh
