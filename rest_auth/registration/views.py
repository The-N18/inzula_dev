...
#         }
#
#         print("in register create data", request_data)
#
#         serializer = self.get_serializer(data=request_data)
#
#         print("in register create serializer", serializer)
#
#
#
#         try:
#             serializer.is_valid(raise_exception=True)
#         except:
#             print("in register create serializer valid")
#
#
#         user = self.perform_create(serializer, request_data)
#         headers = self.get_success_headers(request_data)
...
#
#         print("in register create data", request_data)
#         print("in register create user", user)
#
#         if user.profile.profile_pic:
#             profile_pic_url = user.profile.profile_pic.url
#         if with_discount:
